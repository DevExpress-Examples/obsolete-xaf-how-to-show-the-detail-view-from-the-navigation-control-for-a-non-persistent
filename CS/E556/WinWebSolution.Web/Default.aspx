		...
		<table cellpadding="0" cellspacing="0" border="0" class="FullWidth">
			<tr>
				...
				<tr><td style="padding:4px 4px 4px 21px;">
					    <cc2:VerticalActionContainer ID="VerticalNewActionContainer" runat="server" ContainerId="RootObjectsCreation" CssClass="VContainer" BorderWidth="0px" CellPadding="0" CellSpacing="0"></cc2:VerticalActionContainer>
					    <cc2:VerticalActionContainer ID="VerticalToolsActionContainer" runat="server" ContainerId="Tools" CssClass="VContainer" BorderWidth="0px" CellPadding="0" CellSpacing="0"></cc2:VerticalActionContainer>
